...
import com.suyxin.mvp.App;

/**
 * @author Created by suyxin on 2018/1/24 10:55.
 */
...
public class OverLayCardLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static int  TRANS_Y_GAP = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
            26, App.getContext().getResources().getDisplayMetrics());
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        detachAndScrapAttachedViews(recycler);//解除所有子VIEW
